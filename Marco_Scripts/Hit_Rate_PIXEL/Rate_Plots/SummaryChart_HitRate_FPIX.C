...
//=========  (Mon Jun 28 21:02:57 2021) by ROOT version6.10/04
   TCanvas *canvas = new TCanvas("canvas", "canvas",324,84,953,866);
   gStyle->SetOptStat(0);
   canvas->Range(-2.246996,-0.05654383,11.71963,0.5088945);
   ...
   hb_FPIX__2->SetBinContent(1,0.4308101);
   hb_FPIX__2->SetBinContent(2,0.09238653);
   hb_FPIX__2->SetBinContent(3,0.03454378);
   hb_FPIX__2->SetBinContent(4,0.01735356);
   hb_FPIX__2->SetBinContent(5,0.01719022);
   hb_FPIX__2->SetBinContent(6,0.03102522);
   hb_FPIX__2->SetBinContent(7,0.01521955);
   hb_FPIX__2->SetBinContent(8,0.01580567);
   hb_FPIX__2->SetBinContent(9,0.02681753);
   hb_FPIX__2->SetBinContent(10,0.01322606);
   hb_FPIX__2->SetBinContent(11,0.01359147);
