...
//=========  (Mon Jun 28 21:02:57 2021) by ROOT version6.10/04
   ...
   gStyle->SetOptStat(0);
   canvas->Range(-2.042724,-0.04994555,10.65421,0.5078373);
   ...
   hb_PIXEL__3->SetBinContent(1,0.4308101);
   hb_PIXEL__3->SetBinContent(2,0.3384236);
   hb_PIXEL__3->SetBinContent(3,0.02606975);
   hb_PIXEL__3->SetBinContent(4,0.06354562);
   hb_PIXEL__3->SetBinContent(5,0.1034231);
   hb_PIXEL__3->SetBinContent(6,0.1453851);
   hb_PIXEL__3->SetBinContent(7,0.09238653);
   hb_PIXEL__3->SetBinContent(8,0.03454378);
   hb_PIXEL__3->SetBinContent(9,0.03102522);
   hb_PIXEL__3->SetBinContent(10,0.02681753);
