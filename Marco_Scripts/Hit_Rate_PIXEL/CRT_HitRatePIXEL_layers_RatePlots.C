void CRT_HitRatePIXEL_layers_RatePlots()
{
   /*
       Change the following:
       1) ROOT FILE TFile *file
       2) Check demo or cosmicRateAnalyzer
    */
   TFile *file = new TFile("PixelHitRate_Prompt_Dv2_2018.root");
   ...
   TTree *tree = (TTree*)file->Get("demo/Run");
   ...
   c.SaveAs("hit_rate.C");
   c.Clear();
   gSystem->Exec("mv hit_rate.png Rate_Plots");
   gSystem->Exec("mv hit_rate.pdf Rate_Plots");
   gSystem->Exec("mv hit_rate.C Rate_Plots");
   ...
   c.Clear();
   gSystem->Exec("mv pixel_hit_rate.png Rate_Plots");
   gSystem->Exec("mv pixel_hit_rate.pdf Rate_Plots");
   gSystem->Exec("mv pixel_hit_rate.C Rate_Plots");
   ...
   c.Clear();
   gSystem->Exec("mv fpix_hit_rate.png Rate_Plots");
   gSystem->Exec("mv fpix_hit_rate.pdf Rate_Plots");
   gSystem->Exec("mv fpix_hit_rate.C Rate_Plots");
   //-----------------------------------------------------------------------------------------------
   ...
   c.Clear();
   gSystem->Exec("mv fpix_hit_rate_disk1.png Rate_Plots");
   gSystem->Exec("mv fpix_hit_rate_disk1.pdf Rate_Plots");
   gSystem->Exec("mv fpix_hit_rate_disk1.C Rate_Plots");
   //-----------------------------------------------------------------------------------------------

   //++++++++++++++++++++++++++++++++  FPIX Disk2 hit rate  ++++++++++++++++++++++++++++++++++++++++++++ 
   
   TGraphErrors gr_hit_rate_FPIX_disk2(runNumber_VecD,hit_rate_FPIX_disk2_VecD,runNumber_err_VecD,hit_rate_FPIX_disk2_err_VecD);
   ...
   c.Clear();
   gSystem->Exec("mv fpix_hit_rate_disk2.png Rate_Plots");
   gSystem->Exec("mv fpix_hit_rate_disk2.pdf Rate_Plots");
   gSystem->Exec("mv fpix_hit_rate_disk2.C Rate_Plots");
   //-----------------------------------------------------------------------------------------------
   
    //++++++++++++++++++++++++++++++++  FPIX Disk3 hit rate  ++++++++++++++++++++++++++++++++++++++++++++ 
   
   TGraphErrors gr_hit_rate_FPIX_disk3(runNumber_VecD,hit_rate_FPIX_disk3_VecD,runNumber_err_VecD,hit_rate_FPIX_disk3_err_VecD);
   ...
   c.Clear();
   gSystem->Exec("mv fpix_hit_rate_disk3.png Rate_Plots");
   gSystem->Exec("mv fpix_hit_rate_disk3.pdf Rate_Plots");
   gSystem->Exec("mv fpix_hit_rate_disk3.C Rate_Plots");
   //-----------------------------------------------------------------------------------------------

   //++++++++++++++++++++++++++++++++  FPIX Disk1+ hit rate  ++++++++++++++++++++++++++++++++++++++++++++ 
   
   TGraphErrors gr_hit_rate_FPIX_disk1_plus(runNumber_VecD,hit_rate_FPIX_disk1_plus_VecD,runNumber_err_VecD,hit_rate_FPIX_disk1_plus_err_VecD);
   ...
   c.Clear();
   gSystem->Exec("mv fpix_hit_rate_disk1_plus.png Rate_Plots");
   gSystem->Exec("mv fpix_hit_rate_disk1_plus.pdf Rate_Plots");
   gSystem->Exec("mv fpix_hit_rate_disk1_plus.C Rate_Plots");
   //-----------------------------------------------------------------------------------------------

   //++++++++++++++++++++++++++++++++  FPIX Disk1- hit rate  ++++++++++++++++++++++++++++++++++++++++++++ 
   
   TGraphErrors gr_hit_rate_FPIX_disk1_minus(runNumber_VecD,hit_rate_FPIX_disk1_minus_VecD,runNumber_err_VecD,hit_rate_FPIX_disk1_minus_err_VecD);
   ...
   c.Clear();
   gSystem->Exec("mv fpix_hit_rate_disk1_minus.png Rate_Plots");
   gSystem->Exec("mv fpix_hit_rate_disk1_minus.pdf Rate_Plots");
   gSystem->Exec("mv fpix_hit_rate_disk1_minus.C Rate_Plots");
   //-----------------------------------------------------------------------------------------------

   //++++++++++++++++++++++++++++++++  FPIX Disk2+ hit rate  ++++++++++++++++++++++++++++++++++++++++++++ 
   
   TGraphErrors gr_hit_rate_FPIX_disk2_plus(runNumber_VecD,hit_rate_FPIX_disk2_plus_VecD,runNumber_err_VecD,hit_rate_FPIX_disk2_plus_err_VecD);
   ...
   c.Clear();
   gSystem->Exec("mv fpix_hit_rate_disk2_plus.png Rate_Plots");
   gSystem->Exec("mv fpix_hit_rate_disk2_plus.pdf Rate_Plots");
   gSystem->Exec("mv fpix_hit_rate_disk2_plus.C Rate_Plots");
   //-----------------------------------------------------------------------------------------------

   //++++++++++++++++++++++++++++++++  FPIX Disk2- hit rate  ++++++++++++++++++++++++++++++++++++++++++++ 
   
   TGraphErrors gr_hit_rate_FPIX_disk2_minus(runNumber_VecD,hit_rate_FPIX_disk2_minus_VecD,runNumber_err_VecD,hit_rate_FPIX_disk2_minus_err_VecD);
   ...
   c.Clear();
   gSystem->Exec("mv fpix_hit_rate_disk2_minus.png Rate_Plots");
   gSystem->Exec("mv fpix_hit_rate_disk2_minus.pdf Rate_Plots");
   gSystem->Exec("mv fpix_hit_rate_disk2_minus.C Rate_Plots");
   //-----------------------------------------------------------------------------------------------

   //++++++++++++++++++++++++++++++++  FPIX Disk3+ hit rate  ++++++++++++++++++++++++++++++++++++++++++++ 
   
   TGraphErrors gr_hit_rate_FPIX_disk3_plus(runNumber_VecD,hit_rate_FPIX_disk3_plus_VecD,runNumber_err_VecD,hit_rate_FPIX_disk3_plus_err_VecD);
   ...
   c.Clear();
   gSystem->Exec("mv fpix_hit_rate_disk3_plus.png Rate_Plots");
   gSystem->Exec("mv fpix_hit_rate_disk3_plus.pdf Rate_Plots");
   gSystem->Exec("mv fpix_hit_rate_disk3_plus.C Rate_Plots");
   //-----------------------------------------------------------------------------------------------

   //++++++++++++++++++++++++++++++++  FPIX Disk3- hit rate  ++++++++++++++++++++++++++++++++++++++++++++ 
   
   TGraphErrors gr_hit_rate_FPIX_disk3_minus(runNumber_VecD,hit_rate_FPIX_disk3_minus_VecD,runNumber_err_VecD,hit_rate_FPIX_disk3_minus_err_VecD);
   ...
   c.Clear();
   gSystem->Exec("mv fpix_hit_rate_disk3_minus.png Rate_Plots");
   gSystem->Exec("mv fpix_hit_rate_disk3_minus.pdf Rate_Plots");
   gSystem->Exec("mv fpix_hit_rate_disk3_minus.C Rate_Plots");
   //-----------------------------------------------------------------------------------------------
   ...
   c.Clear();
   gSystem->Exec("mv bpix_hit_rate.png Rate_Plots");
   gSystem->Exec("mv bpix_hit_rate.pdf Rate_Plots");
   gSystem->Exec("mv bpix_hit_rate.C Rate_Plots");
   
   //-----------------------------------------------------------------------------------------------

   //++++++++++++++++++++++++++++++++  BPIX layer 1 hit rate  ++++++++++++++++++++++++++++++++++++++++++++ 
   
   TGraphErrors gr_hit_rate_BPIX_layer1(runNumber_VecD,hit_rate_BPIX_layer1_VecD,runNumber_err_VecD,hit_rate_BPIX_layer1_err_VecD);
   ...
   c.Clear();
   gSystem->Exec("mv bpix_layer1_hit_rate.png Rate_Plots");
   gSystem->Exec("mv bpix_layer1_hit_rate.pdf Rate_Plots");
   gSystem->Exec("mv bpix_layer1_hit_rate.C Rate_Plots");
   
   //-----------------------------------------------------------------------------------------------

   //++++++++++++++++++++++++++++++++  BPIX layer 2 hit rate  ++++++++++++++++++++++++++++++++++++++++++++ 
   
   TGraphErrors gr_hit_rate_BPIX_layer2(runNumber_VecD,hit_rate_BPIX_layer2_VecD,runNumber_err_VecD,hit_rate_BPIX_layer2_err_VecD);
   ...
   c.Clear();
   gSystem->Exec("mv bpix_layer2_hit_rate.png Rate_Plots");
   gSystem->Exec("mv bpix_layer2_hit_rate.pdf Rate_Plots");
   gSystem->Exec("mv bpix_layer2_hit_rate.C Rate_Plots");
   
   //-----------------------------------------------------------------------------------------------

   //++++++++++++++++++++++++++++++++  BPIX layer 3 hit rate  ++++++++++++++++++++++++++++++++++++++++++++ 
   
   TGraphErrors gr_hit_rate_BPIX_layer3(runNumber_VecD,hit_rate_BPIX_layer3_VecD,runNumber_err_VecD,hit_rate_BPIX_layer3_err_VecD);
   ...
   c.Clear();
   gSystem->Exec("mv bpix_layer3_hit_rate.png Rate_Plots");
   gSystem->Exec("mv bpix_layer3_hit_rate.pdf Rate_Plots");
   gSystem->Exec("mv bpix_layer3_hit_rate.C Rate_Plots");
   
   //-----------------------------------------------------------------------------------------------
   
   //++++++++++++++++++++++++++++++++  BPIX layer 4 hit rate  ++++++++++++++++++++++++++++++++++++++++++++ 
   
   TGraphErrors gr_hit_rate_BPIX_layer4(runNumber_VecD,hit_rate_BPIX_layer4_VecD,runNumber_err_VecD,hit_rate_BPIX_layer4_err_VecD);
   ...
   c.Clear();
   gSystem->Exec("mv bpix_layer4_hit_rate.png Rate_Plots");
   gSystem->Exec("mv bpix_layer4_hit_rate.pdf Rate_Plots");
   gSystem->Exec("mv bpix_layer4_hit_rate.C Rate_Plots");
   ...
   //xxxxxxxxxxxxxxxxxxxxxxxxxxxx TRACK RATE xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx//
   int Runs=0; float weigh=0;
   for (int k = 0; k < j; k++)
     {
       weight.push_back( hits.at(k)/nTotalHits );
       std::cout<<"Weight of "<<k<<"the Run with "<<hits.at(k)<<" hits is :"<<weight[k]<<std::endl;
       Runs++; weigh+=weight[k];
     }
   std::cout<<"Total Runs in weight loop : "<<Runs<<std::endl;
   std::cout<<"Total weigh : "<<weigh<<std::endl;
   ...
   tex.DrawLatexNDC(0.4,0.8,"Hit Rate Summary BPIX");
   tex.SetLineWidth(2);
   tex.SetTextFont(62);
   tex.Draw();
   ...
   tex.DrawLatexNDC(0.4,0.8,"Hit Rate Summary FPIX");
   tex.SetLineWidth(2);
   tex.SetTextFont(62);
   tex.Draw();
   ...
   tex.DrawLatexNDC(0.4,0.8,"Hit Rate Summary PIXEL");
   tex.SetLineWidth(2);
   tex.SetTextFont(62);
   tex.Draw();
   ...
   TTree *tree_Event = (TTree*)file->Get("demo/Event");
   
   vector<double> *pt; pt=0;
   vector<double> *hits_Tot, *hits_PIXEL, *hits_BPIX, *hits_FPIX;

   tree_Event->SetBranchAddress("pt", &pt);
   tree_Event->SetBranchAddress("nHitsValid", &hits_Tot);
   tree_Event->SetBranchAddress("nHitsPIXEL", &hits_PIXEL);
   tree_Event->SetBranchAddress("nHitsBPIX", &hits_BPIX);
   tree_Event->SetBranchAddress("nHitsFPIX", &hits_FPIX);

   hits_Tot=0, hits_PIXEL=0, hits_BPIX=0, hits_FPIX=0;

   
   int CheckTotalEvents=0, TotalHits=0,  TotalHits_PIXEL=0,  TotalHits_BPIX=0,  TotalHits_FPIX=0 ;
   Long64_t nTotalEvents2 = tree_Event->GetEntriesFast();   
   for(Long64_t event=0; event<nTotalEvents2; event++)
     {
       tree_Event->GetEntry(event);
       CheckTotalEvents++;
       for(int track =0 ; track < pt->size(); track++)
	 {
	   TotalHits += hits_Tot->at(track);
	   TotalHits_PIXEL += hits_PIXEL->at(track);
	   TotalHits_BPIX += hits_BPIX->at(track);
	   TotalHits_FPIX += hits_FPIX->at(track);
	 }
       
     }

   std::cout<<"From event Tree: "<<std::endl;
   std::cout<<" Total Hits: "<<TotalHits<<std::endl;
   std::cout<<" Total Hits PIXEL: "<<TotalHits_PIXEL<<std::endl;
   std::cout<<" Total Hits BPIX: "<<TotalHits_BPIX<<std::endl;
   std::cout<<" Total Hits FPIX: "<<TotalHits_FPIX<<std::endl;
}
