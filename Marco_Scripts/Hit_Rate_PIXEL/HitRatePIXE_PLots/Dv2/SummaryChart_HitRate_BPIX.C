...
//=========  (Mon Jun 28 19:39:24 2021) by ROOT version6.10/04
   ...
   gStyle->SetOptStat(0);
   canvas->Range(-1.225634,-0.04994555,6.392523,0.5078373);
   ...
   hb_BPIX__1->SetBinContent(1,0.4308101);
   hb_BPIX__1->SetBinContent(2,0.3384236);
   hb_BPIX__1->SetBinContent(3,0.02606975);
   hb_BPIX__1->SetBinContent(4,0.06354562);
   hb_BPIX__1->SetBinContent(5,0.1034231);
   hb_BPIX__1->SetBinContent(6,0.1453851);
