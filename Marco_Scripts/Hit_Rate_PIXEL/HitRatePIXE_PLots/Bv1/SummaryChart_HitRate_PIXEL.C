...
//=========  (Mon Jun 28 19:38:18 2021) by ROOT version6.10/04
   ...
   gStyle->SetOptStat(0);
   canvas->Range(-2.042724,-0.05631088,10.65421,0.5583203);
   ...
   hb_PIXEL__3->SetBinContent(1,0.4734426);
   hb_PIXEL__3->SetBinContent(2,0.3742393);
   hb_PIXEL__3->SetBinContent(3,0.02745178);
   hb_PIXEL__3->SetBinContent(4,0.06786827);
   hb_PIXEL__3->SetBinContent(5,0.1135992);
   hb_PIXEL__3->SetBinContent(6,0.1653201);
   hb_PIXEL__3->SetBinContent(7,0.09920332);
   hb_PIXEL__3->SetBinContent(8,0.03745369);
   hb_PIXEL__3->SetBinContent(9,0.03208875);
   hb_PIXEL__3->SetBinContent(10,0.02966088);
