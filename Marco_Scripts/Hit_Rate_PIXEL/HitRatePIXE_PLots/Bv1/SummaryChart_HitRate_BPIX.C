...
//=========  (Mon Jun 28 19:38:18 2021) by ROOT version6.10/04
   ...
   gStyle->SetOptStat(0);
   canvas->Range(-1.225634,-0.05631088,6.392523,0.5583203);
   ...
   hb_BPIX__1->SetBinContent(1,0.4734426);
   hb_BPIX__1->SetBinContent(2,0.3742393);
   hb_BPIX__1->SetBinContent(3,0.02745178);
   hb_BPIX__1->SetBinContent(4,0.06786827);
   hb_BPIX__1->SetBinContent(5,0.1135992);
   hb_BPIX__1->SetBinContent(6,0.1653201);
