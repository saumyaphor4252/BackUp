...
//=========  (Mon Jun 28 19:36:20 2021) by ROOT version6.10/04
   ...
   gStyle->SetOptStat(0);
   canvas->Range(-2.246996,-0.0548414,11.71963,0.4935726);
   ...
   hb_FPIX__2->SetBinContent(1,0.4178392);
   hb_FPIX__2->SetBinContent(2,0.07373913);
   hb_FPIX__2->SetBinContent(3,0.02747695);
   hb_FPIX__2->SetBinContent(4,0.01368409);
   hb_FPIX__2->SetBinContent(5,0.01379286);
   hb_FPIX__2->SetBinContent(6,0.02471205);
   hb_FPIX__2->SetBinContent(7,0.01194041);
   hb_FPIX__2->SetBinContent(8,0.01277163);
   hb_FPIX__2->SetBinContent(9,0.02155014);
   hb_FPIX__2->SetBinContent(10,0.0106467);
   hb_FPIX__2->SetBinContent(11,0.01090344);
