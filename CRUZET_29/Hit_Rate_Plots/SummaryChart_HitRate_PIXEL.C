...
//=========  (Fri Jul 30 11:36:11 2021) by ROOT version6.10/04
   ...
   gStyle->SetOptStat(0);
   canvas->Range(-2.042724,-0.03894104,10.65421,0.4268697);
   ...
   hb_PIXEL__3->SetBinContent(1,0.3625434);
   hb_PIXEL__3->SetBinContent(2,0.3006082);
   hb_PIXEL__3->SetBinContent(3,0.02640784);
   hb_PIXEL__3->SetBinContent(4,0.06267946);
   hb_PIXEL__3->SetBinContent(5,0.09544951);
   hb_PIXEL__3->SetBinContent(6,0.1371792);
   hb_PIXEL__3->SetBinContent(7,0.06897123);
   hb_PIXEL__3->SetBinContent(8,0.03033505);
   hb_PIXEL__3->SetBinContent(9,0.02816791);
   hb_PIXEL__3->SetBinContent(10,0.0245402);
