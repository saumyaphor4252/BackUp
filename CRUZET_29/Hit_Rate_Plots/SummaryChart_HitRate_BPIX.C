...
//=========  (Fri Jul 30 11:36:10 2021) by ROOT version6.10/04
   ...
   gStyle->SetOptStat(0);
   canvas->Range(-1.225634,-0.03672263,6.392523,0.4265142);
   ...
   hb_BPIX__1->SetBinContent(1,0.3625434);
   hb_BPIX__1->SetBinContent(2,0.3006082);
   hb_BPIX__1->SetBinContent(3,0.02640784);
   hb_BPIX__1->SetBinContent(4,0.06267946);
   hb_BPIX__1->SetBinContent(5,0.09544951);
   hb_BPIX__1->SetBinContent(6,0.1371792);
