...
//=========  (Fri Jul 30 11:10:16 2021) by ROOT version6.10/04
   TCanvas *canvas = new TCanvas("canvas", "canvas",0,0,986,870);
   gStyle->SetOptStat(0);
   canvas->Range(-1.881491,0.03530719,9.910786,0.3693857);
   ...
   hb_TEC__2->SetBinContent(1,0.3297204);
   hb_TEC__2->SetBinContent(2,0.2918502);
   hb_TEC__2->SetBinContent(3,0.2608705);
   hb_TEC__2->SetBinContent(4,0.221525);
   hb_TEC__2->SetBinContent(5,0.1983461);
   hb_TEC__2->SetBinContent(6,0.1661315);
   hb_TEC__2->SetBinContent(7,0.1306228);
   hb_TEC__2->SetBinContent(8,0.1048386);
   hb_TEC__2->SetBinContent(9,0.08114387);
