...
//=========  (Fri Jul 30 10:59:59 2021) by ROOT version6.10/04
   TCanvas *canvas = new TCanvas("canvas", "canvas",372,57,986,870);
   gStyle->SetOptStat(0);
   canvas->Range(-2.566757,0.0362871,13.52044,0.3680803);
   ...
   canvas->SetTopMargin(0.07628129);
   ...
   TPaveText *pt = new TPaveText(0.2356231,0.9349285,0.7643769,0.995,"blNDC");
   pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetFillColor(0);
   pt->SetFillStyle(0);
