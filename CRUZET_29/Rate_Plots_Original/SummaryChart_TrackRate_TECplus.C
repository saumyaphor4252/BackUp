...
//=========  (Fri Jul 30 11:10:17 2021) by ROOT version6.10/04
   TCanvas *canvas = new TCanvas("canvas", "canvas",0,0,986,870);
   gStyle->SetOptStat(0);
   canvas->Range(-1.881491,0.03994159,9.910786,0.2118371);
   ...
   hb_TECp__3->SetBinContent(1,0.1914279);
   hb_TECp__3->SetBinContent(2,0.167888);
   hb_TECp__3->SetBinContent(3,0.1484392);
   hb_TECp__3->SetBinContent(4,0.1284391);
   hb_TECp__3->SetBinContent(5,0.1168026);
   hb_TECp__3->SetBinContent(6,0.1018123);
   hb_TECp__3->SetBinContent(7,0.08583329);
   hb_TECp__3->SetBinContent(8,0.07425443);
   hb_TECp__3->SetBinContent(9,0.06352623);
   ...
   hb_TECp__3->GetYaxis()->SetTitleOffset(0);
   hb_TECp__3->GetYaxis()->SetTitleFont(42);
   hb_TECp__3->GetZaxis()->SetLabelFont(42);
   hb_TECp__3->GetZaxis()->SetLabelSize(0.035);
   hb_TECp__3->GetZaxis()->SetTitleSize(0.035);
   hb_TECp__3->GetZaxis()->SetTitleFont(42);
   hb_TECp__3->Draw("bTEXT");
   
   TPaveText *pt = new TPaveText(0.275061,0.9350713,0.724939,0.995,"blNDC");
   pt->SetName("title");
   pt->SetBorderSize(0);
   pt->SetFillColor(0);
   pt->SetFillStyle(0);
