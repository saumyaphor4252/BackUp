...
//=========  (Fri Jul 30 11:10:17 2021) by ROOT version6.10/04
   ...
   gStyle->SetOptStat(0);
   canvas->Range(-1.881491,-0.1764023,9.910786,1.58762);
   ...
   hb_TECm__4->SetBinContent(1,0.1384812);
   hb_TECm__4->SetBinContent(2,0.1742384);
   hb_TECm__4->SetBinContent(3,0.8056985);
   hb_TECm__4->SetBinContent(4,0.7863407);
   hb_TECm__4->SetBinContent(5,0.08164169);
   hb_TECm__4->SetBinContent(6,0.06439283);
   hb_TECm__4->SetBinContent(7,1.378177);
   hb_TECm__4->SetBinContent(8,0.4360934);
   hb_TECm__4->SetBinContent(9,1.017653);
