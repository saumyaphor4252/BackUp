...
//=========  (Fri Jul 30 11:10:16 2021) by ROOT version6.10/04
   ...
   gStyle->SetOptStat(0);
   can->Range(-1.634179,-0.5373835,8.523364,4.836451);
   can->SetFillColor(0);
   can->SetBorderMode(0);
   can->SetBorderSize(2);
   can->SetGridx();
   ...
   h1b__1->SetBinContent(1,4.09435);
   h1b__1->SetBinContent(2,2.332132);
   h1b__1->SetBinContent(3,0.08556706);
   h1b__1->SetBinContent(4,0.1305764);
   h1b__1->SetBinContent(5,0.9936709);
   h1b__1->SetBinContent(6,0.3133681);
   h1b__1->SetBinContent(7,2.231997);
   h1b__1->SetBinContent(8,0.4023577);
