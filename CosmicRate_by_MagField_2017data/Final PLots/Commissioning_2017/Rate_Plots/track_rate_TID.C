...
//=========  (Thu Jun 24 11:23:55 2021) by ROOT version6.10/04
   ...
   gStyle->SetOptStat(0);
   Canvas6->Range(289175.3,-0.2264077,293420,1.523106);
   ...
   0.02207199,
   0.0163966};
   TGraphErrors *gre = new TGraphErrors(375,Graph_fx1013,Graph_fy1013,Graph_fex1013,Graph_fey1013);
   gre->SetName("Graph");
   gre->SetTitle("Graph");
   gre->SetFillColor(1);
   ...
   TH1F *Graph_Graph1013 = new TH1F("Graph_Graph1013","Graph",375,289825.9,293403.1);
   Graph_Graph1013->SetMinimum(0);
   Graph_Graph1013->SetMaximum(1.435113);
   ...
   0.08262862,
   0.0517173};
   gre = new TGraphErrors(62,Graph_fx1014,Graph_fy1014,Graph_fex1014,Graph_fey1014);
   gre->SetName("Graph");
   gre->SetTitle("Graph");
   gre->SetFillColor(1);
   ...
   TH1F *Graph_Graph1014 = new TH1F("Graph_Graph1014","Graph",100,293391,294591);
   Graph_Graph1014->SetMinimum(0.03000833);
   Graph_Graph1014->SetMaximum(0.8441424);
