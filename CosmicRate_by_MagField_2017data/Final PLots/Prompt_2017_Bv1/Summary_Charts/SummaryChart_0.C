...
//=========  (Thu Jun 24 10:23:58 2021) by ROOT version6.10/04
   ...
   c->Range(-1.553285,-0.69542,8.420438,4.882134);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   h1b__1->SetBinContent(1,4.118456);
   h1b__1->SetBinContent(2,2.502703);
   h1b__1->SetBinContent(3,0.02952582);
   h1b__1->SetBinContent(4,0.0889409);
   h1b__1->SetBinContent(5,1.211905);
   h1b__1->SetBinContent(6,0.3515836);
   h1b__1->SetBinContent(7,2.382646);
   h1b__1->SetBinContent(8,0.4405129);
