...
//=========  (Thu Jun 24 10:23:58 2021) by ROOT version6.10/04
   TCanvas *c = new TCanvas("c", "c",0,0,856,842);
   c->Range(-1.553285,-0.5973169,8.420438,4.19341);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   h1b__2->SetBinContent(1,3.537464);
   h1b__2->SetBinContent(2,2.538951);
   h1b__2->SetBinContent(3,0.04137088);
   h1b__2->SetBinContent(4,0.09376965);
   h1b__2->SetBinContent(5,1.051479);
   h1b__2->SetBinContent(6,0.5236271);
   h1b__2->SetBinContent(7,2.371465);
   h1b__2->SetBinContent(8,0.6841648);
