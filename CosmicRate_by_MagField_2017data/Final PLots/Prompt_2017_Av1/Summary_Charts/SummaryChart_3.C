...
//=========  (Thu Jun 24 10:35:11 2021) by ROOT version6.10/04
   TCanvas *c = new TCanvas("c", "c",0,0,856,842);
   c->Range(-1.553285,-0.5910185,8.420438,4.149192);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   h1b__2->SetBinContent(1,3.500163);
   h1b__2->SetBinContent(2,2.503541);
   h1b__2->SetBinContent(3,0.01065521);
   h1b__2->SetBinContent(4,0.02781405);
   h1b__2->SetBinContent(5,1.012777);
   h1b__2->SetBinContent(6,0.5248503);
   h1b__2->SetBinContent(7,2.302116);
   h1b__2->SetBinContent(8,0.7440209);
