...
//=========  (Wed Jun 23 19:43:55 2021) by ROOT version6.10/04
   ...
   c->Range(294354,-0.1731712,296406,1.55854);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   0.02133245,
   0.01131157};
   TGraphErrors *gre = new TGraphErrors(61,Graph0_fx1007,Graph0_fy1007,Graph0_fex1007,Graph0_fey1007);
   gre->SetName("Graph0");
   ...
   TH1F *Graph_Graph1007 = new TH1F("Graph_Graph1007","TIB Track Rate",100,294559.2,296200.8);
   Graph_Graph1007->SetMinimum(0);
   Graph_Graph1007->SetMaximum(1.385369);
