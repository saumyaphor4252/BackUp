...
//=========  (Wed Jun 23 19:43:55 2021) by ROOT version6.10/04
   ...
   c->Range(-1,-0.4593964,9,4.134568);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   h1b__1->SetBinContent(1,3.500163);
   h1b__1->SetBinContent(2,2.503541);
   h1b__1->SetBinContent(3,0.01065521);
   h1b__1->SetBinContent(4,0.02781405);
   h1b__1->SetBinContent(5,1.012777);
   h1b__1->SetBinContent(6,0.5248503);
   h1b__1->SetBinContent(7,2.302116);
   h1b__1->SetBinContent(8,0.7440209);
