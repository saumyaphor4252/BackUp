...
//=========  (Wed Jun 23 19:46:57 2021) by ROOT version6.10/04
   ...
   0,
   0};
   TGraphErrors *gre = new TGraphErrors(437,Graph0_fx1003,Graph0_fy1003,Graph0_fex1003,Graph0_fey1003);
   gre->SetName("Graph0");
   ...
   TH1F *Graph_Graph1003 = new TH1F("Graph_Graph1003","Pixel Track Rate",437,289687.3,294927.7);
