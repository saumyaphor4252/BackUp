...
//=========  (Wed Jun 23 19:46:57 2021) by ROOT version6.10/04
   ...
   c->Range(289032.2,-0.01395394,295582.8,0.1255855);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   0,
   0};
   TGraphErrors *gre = new TGraphErrors(437,Graph0_fx1005,Graph0_fy1005,Graph0_fex1005,Graph0_fey1005);
   gre->SetName("Graph0");
   ...
   TH1F *Graph_Graph1005 = new TH1F("Graph_Graph1005","BPIX Track Rate",437,289687.3,294927.7);
