...
void CRT_RatePlots_ByField()
{
  /*
     ...
     3) Change the top right title & legend
  ...
  //vector<double> available_Mag_Field = {3.8112};
  ...
  TMultiGraph mg_track_rate_TID_plus("track rate tid plus","Track Rate TID+");
  TMultiGraph mg_track_rate_TID_minus("track rate tid minus","Track Rate TID-");
  TMultiGraph mg_track_rate_TOB("track rate tob","Track Rate TOB");
  TMultiGraph mg_track_rate_TEC("track rate tec","Track Rate TEC");
  TMultiGraph mg_track_rate_TEC_plus("track rate tec plus","Track Rate TEC+");
  TMultiGraph mg_track_rate_TEC_minus("track rate tec minus","Track Rate TEC-");
  ...
  for(auto& it : available_Mag_Field)
    {
      ...
      if(color_i==0) {  ci=TColor::GetColor("#3113ba"); } // Blue for 0 T
      else if(color_i==1) { ci=TColor::GetColor("#de0b1d"); } // REd for 4T
      else { ci=TColor::GetColor("#33cc33");     }
      //ci=TColor::GetColor("#de0b1d"); Av1 
      ...
      for (Long64_t jentry=0; jentry<n; jentry++)  // Loop over all Runs
	{
      ...
      TVectorD  track_rate_TID_plus_VecD        ;
      TVectorD  track_rate_TID_plus_err_VecD 	;
      TVectorD  track_rate_TID_minus_VecD       ;
      TVectorD  track_rate_TID_minus_err_VecD 	;
      TVectorD  track_rate_TOB_VecD     	;
      TVectorD  track_rate_TOB_err_VecD 	;
      TVectorD  track_rate_TEC_VecD 	        ;
      TVectorD  track_rate_TEC_err_VecD 	;
      TVectorD  track_rate_TEC_plus_VecD        ;
      TVectorD  track_rate_TEC_plus_err_VecD 	;
      TVectorD  track_rate_TEC_minus_VecD       ;
      TVectorD  track_rate_TEC_minus_err_VecD 	;
      ...
      track_rate_TID_plus_VecD.Use(track_rate_TID_plus.size(),&(track_rate_TID_plus[0]));
      track_rate_TID_plus_err_VecD.Use(track_rate_TID_plus_err.size(),&(track_rate_TID_plus_err[0]));
      track_rate_TID_minus_VecD.Use(track_rate_TID_minus.size(),&(track_rate_TID_minus[0]));
      track_rate_TID_minus_err_VecD.Use(track_rate_TID_minus_err.size(),&(track_rate_TID_minus_err[0]));    
      ...
      track_rate_TEC_plus_VecD.Use(track_rate_TEC_plus.size(),&(track_rate_TEC_plus[0]));
      track_rate_TEC_plus_err_VecD.Use(track_rate_TEC_plus_err.size(),&(track_rate_TEC_plus_err[0]));
      track_rate_TEC_minus_VecD.Use(track_rate_TEC_minus.size(),&(track_rate_TEC_minus[0]));
      track_rate_TEC_minus_err_VecD.Use(track_rate_TEC_minus_err.size(),&(track_rate_TEC_minus_err[0]));
 
      //===========  Legend  ============//
      TLegend *leg = new TLegend(0.6978923,0.7320513,0.9262295,0.874359,NULL,"brNDC"); //Commsssioning or Bv1
      // TLegend *leg = new TLegend(0.234192,0.6815366,0.4754098,0.8042131,NULL,"brNDC"); //Av1
      leg->SetBorderSize(1);
      ...
      entry->SetLineStyle(1);
      entry->SetLineWidth(1);    
      entry->SetMarkerColor(TColor::GetColor("#3113ba"));
      ...
      entry->SetLineStyle(1);
      entry->SetLineWidth(1);     
      entry->SetMarkerColor(TColor::GetColor("#de0b1d"));
      entry->SetMarkerStyle(20);
      entry->SetMarkerSize(1.4);
      entry->SetTextFont(42);
      ...
      //top_right_Title.DrawLatexNDC(0.685, 0.94, "cosmic rays (2017)");      
      ...
      //++++++++++++++++++++++++++++++++  TID+ track rate  ++++++++++++++++++++++++++++++++++++++++++++
      Canvas[7]->cd();
      TGraphErrors *gr_track_rate_TID_plus = new TGraphErrors(runNumber_VecD,track_rate_TID_plus_VecD,runNumber_err_VecD,track_rate_TID_plus_err_VecD);
      gr_track_rate_TID_plus->GetXaxis()->SetTitle("Run Number");
      gr_track_rate_TID_plus->GetXaxis()->SetLabelSize(0.03);
      gr_track_rate_TID_plus->GetXaxis()->SetNoExponent();
      gr_track_rate_TID_plus->GetYaxis()->SetTitle("Track Rate (Hz)");
      gr_track_rate_TID_plus->SetMarkerStyle(20);
      gr_track_rate_TID_plus->SetMarkerSize(1.4);
      gr_track_rate_TID_plus->SetMarkerColor(ci);
      mg_track_rate_TID_plus.Add(gr_track_rate_TID_plus);
      mg_track_rate_TID_plus.Draw("AP");
      mg_track_rate_TID_plus.SetTitle("");
      mg_track_rate_TID_plus.GetXaxis()->SetTitle("Run Number");
      mg_track_rate_TID_plus.GetXaxis()->SetLabelSize(0.03);
      mg_track_rate_TID_plus.GetXaxis()->SetTitleSize(0.05);
      mg_track_rate_TID_plus.GetXaxis()->SetNoExponent();
      mg_track_rate_TID_plus.GetYaxis()->SetTitle("Track Rate (Hz)");
      mg_track_rate_TID_plus.GetYaxis()->SetLabelSize(0.05);
      mg_track_rate_TID_plus.GetYaxis()->SetTitleSize(0.05);
      mg_track_rate_TID_plus.GetYaxis()->SetTitleFont(42);
      top_right_Title.DrawLatexNDC(0.49, 0.94, "cosmic rays 2017 (Commissioning)");
      //top_right_Title.DrawLatexNDC(0.685, 0.94, "cosmic rays (2017)");  
      detector.DrawLatexNDC(0.23, 0.83, "TID+");
      leg->Draw();
      ...
      //++++++++++++++++++++++++++++++++  TID- track rate  ++++++++++++++++++++++++++++++++++++++++++++
      Canvas[8]->cd();
      TGraphErrors *gr_track_rate_TID_minus = new TGraphErrors(runNumber_VecD,track_rate_TID_minus_VecD,runNumber_err_VecD,track_rate_TID_minus_err_VecD);
      gr_track_rate_TID_minus->GetXaxis()->SetTitle("Run Number");
      gr_track_rate_TID_minus->GetXaxis()->SetLabelSize(0.03);
      gr_track_rate_TID_minus->GetXaxis()->SetNoExponent();
      gr_track_rate_TID_minus->GetYaxis()->SetTitle("Track Rate (Hz)");
      gr_track_rate_TID_minus->SetMarkerStyle(20);
      gr_track_rate_TID_minus->SetMarkerSize(1.4);
      gr_track_rate_TID_minus->SetMarkerColor(ci);
      mg_track_rate_TID_minus.Add(gr_track_rate_TID_minus);
      mg_track_rate_TID_minus.Draw("AP");
      mg_track_rate_TID_minus.SetTitle("");
      mg_track_rate_TID_minus.GetXaxis()->SetTitle("Run Number");
      mg_track_rate_TID_minus.GetXaxis()->SetLabelSize(0.03);
      mg_track_rate_TID_minus.GetXaxis()->SetTitleSize(0.05);
      mg_track_rate_TID_minus.GetXaxis()->SetNoExponent();
      mg_track_rate_TID_minus.GetYaxis()->SetTitle("Track Rate (Hz)");
      mg_track_rate_TID_minus.GetYaxis()->SetLabelSize(0.05);
      mg_track_rate_TID_minus.GetYaxis()->SetTitleSize(0.05);
      mg_track_rate_TID_minus.GetYaxis()->SetTitleFont(42);
      top_right_Title.DrawLatexNDC(0.49, 0.94, "cosmic rays 2017 (Commissioning)");
      //top_right_Title.DrawLatexNDC(0.685, 0.94, "cosmic rays (2017)");  
      detector.DrawLatexNDC(0.23, 0.83, "TID-");
      leg->Draw();
      ...
      //++++++++++++++++++++++++++++++++ TEC+ track rate  ++++++++++++++++++++++++++++++++++++++++++++
      Canvas[11]->cd();
      TGraphErrors *gr_track_rate_TEC_plus = new TGraphErrors(runNumber_VecD,track_rate_TEC_plus_VecD,runNumber_err_VecD,track_rate_TEC_plus_err_VecD);
      gr_track_rate_TEC_plus->GetXaxis()->SetTitle("Run Number");
      gr_track_rate_TEC_plus->GetXaxis()->SetLabelSize(0.03);
      gr_track_rate_TEC_plus->GetXaxis()->SetNoExponent();
      gr_track_rate_TEC_plus->GetYaxis()->SetTitle("Track Rate (Hz)");
      gr_track_rate_TEC_plus->SetMarkerStyle(20);
      gr_track_rate_TEC_plus->SetMarkerSize(1.4);
      gr_track_rate_TEC_plus->SetMarkerColor(ci);
      mg_track_rate_TEC_plus.Add(gr_track_rate_TEC_plus);
      mg_track_rate_TEC_plus.Draw("AP");
      mg_track_rate_TEC_plus.SetTitle("");
      mg_track_rate_TEC_plus.GetXaxis()->SetTitle("Run Number");
      mg_track_rate_TEC_plus.GetXaxis()->SetLabelSize(0.03);
      mg_track_rate_TEC_plus.GetXaxis()->SetTitleSize(0.05);
      mg_track_rate_TEC_plus.GetXaxis()->SetNoExponent();
      mg_track_rate_TEC_plus.GetYaxis()->SetTitle("Track Rate (Hz)");
      mg_track_rate_TEC_plus.GetYaxis()->SetLabelSize(0.05);
      mg_track_rate_TEC_plus.GetYaxis()->SetTitleSize(0.05);
      mg_track_rate_TEC_plus.GetYaxis()->SetTitleFont(42);
      top_right_Title.DrawLatexNDC(0.49, 0.94, "cosmic rays 2017 (Commissioning)");
      //top_right_Title.DrawLatexNDC(0.685, 0.94, "cosmic rays (2017)");  
      detector.DrawLatexNDC(0.23, 0.83, "TEC+");
      leg->Draw();
      ...
      //++++++++++++++++++++++++++++++++  TEC- track rate  ++++++++++++++++++++++++++++++++++++++++++++
      Canvas[12]->cd();
      TGraphErrors *gr_track_rate_TEC_minus = new TGraphErrors(runNumber_VecD,track_rate_TEC_minus_VecD,runNumber_err_VecD,track_rate_TEC_minus_err_VecD);
      gr_track_rate_TEC_minus->GetXaxis()->SetTitle("Run Number");
      gr_track_rate_TEC_minus->GetXaxis()->SetLabelSize(0.03);
      gr_track_rate_TEC_minus->GetXaxis()->SetNoExponent();
      gr_track_rate_TEC_minus->GetYaxis()->SetTitle("Track Rate (Hz)");
      gr_track_rate_TEC_minus->SetMarkerStyle(20);
      gr_track_rate_TEC_minus->SetMarkerSize(1.4);
      gr_track_rate_TEC_minus->SetMarkerColor(ci);
      mg_track_rate_TEC_minus.Add(gr_track_rate_TEC_minus);
      mg_track_rate_TEC_minus.Draw("AP");
      mg_track_rate_TEC_minus.SetTitle("");
      mg_track_rate_TEC_minus.GetXaxis()->SetTitle("Run Number");
      mg_track_rate_TEC_minus.GetXaxis()->SetLabelSize(0.03);
      mg_track_rate_TEC_minus.GetXaxis()->SetTitleSize(0.05);
      mg_track_rate_TEC_minus.GetXaxis()->SetNoExponent();
      mg_track_rate_TEC_minus.GetYaxis()->SetTitle("Track Rate (Hz)");
      mg_track_rate_TEC_minus.GetYaxis()->SetLabelSize(0.05);
      mg_track_rate_TEC_minus.GetYaxis()->SetTitleSize(0.05);
      mg_track_rate_TEC_minus.GetYaxis()->SetTitleFont(42);
      top_right_Title.DrawLatexNDC(0.49, 0.94, "cosmic rays 2017 (Commissioning)");
      //top_right_Title.DrawLatexNDC(0.685, 0.94, "cosmic rays (2017)");  
      detector.DrawLatexNDC(0.23, 0.83, "TEC-");
      leg->Draw();
      ...
      for (int a = 0; a < nRuns_with_this_MagField ; a++)
	{
      ...
      h1b.Draw("bTEXT");
      TString summary_chart_title = Form("SummaryChart_%f", it);
      ...
      for(int i =0; i<3 ; i++)
	{
	  ...
	  TString mv_cmd = "mv " + filename + " Rate_Plots_try";
  ...
  Canvas[7]->SaveAs("track_rate_TID_plus.png");
  Canvas[8]->SaveAs("track_rate_TID_minus.png");
  Canvas[9]->SaveAs("track_rate_TOB.png");
  Canvas[10]->SaveAs("track_rate_TEC.png");
  Canvas[11]->SaveAs("track_rate_TEC_plus.png");
  Canvas[12]->SaveAs("track_rate_TEC_minus.png");
  ...
  gSystem->Exec("mv track_rate_TID_plus.png Rate_Plots_try");
  gSystem->Exec("mv track_rate_TID_minus.png Rate_Plots_try");
  gSystem->Exec("mv track_rate_TOB.png Rate_Plots_try");
  gSystem->Exec("mv track_rate_TEC.png Rate_Plots_try");
  gSystem->Exec("mv track_rate_TEC_plus.png Rate_Plots_try");
  gSystem->Exec("mv track_rate_TEC_minus.png Rate_Plots_try");
  ...
  Canvas[7]->SaveAs("track_rate_TID_plus.pdf");
  Canvas[8]->SaveAs("track_rate_TID_minus.pdf");
  Canvas[9]->SaveAs("track_rate_TOB.pdf");
  Canvas[10]->SaveAs("track_rate_TEC.pdf");
  Canvas[11]->SaveAs("track_rate_TEC_plus.pdf");
  Canvas[12]->SaveAs("track_rate_TEC_minus.pdf");
  ...
  gSystem->Exec("mv track_rate_TID_plus.pdf Rate_Plots_try");
  gSystem->Exec("mv track_rate_TID_minus.pdf Rate_Plots_try");
  gSystem->Exec("mv track_rate_TOB.pdf Rate_Plots_try");
  gSystem->Exec("mv track_rate_TEC.pdf Rate_Plots_try");
  gSystem->Exec("mv track_rate_TEC_plus.pdf Rate_Plots_try");
  gSystem->Exec("mv track_rate_TEC_minus.pdf Rate_Plots_try");
  ...
  Canvas[7]->SaveAs("track_rate_TID_plus.C");
  Canvas[8]->SaveAs("track_rate_TID_minus.C");
  Canvas[9]->SaveAs("track_rate_TOB.C");
  Canvas[10]->SaveAs("track_rate_TEC.C");
  Canvas[11]->SaveAs("track_rate_TEC_plus.C");
  Canvas[12]->SaveAs("track_rate_TEC_minus.C");
  ...
  gSystem->Exec("mv track_rate_TID_plus.C Rate_Plots_try");
  gSystem->Exec("mv track_rate_TID_minus.C Rate_Plots_try");
  gSystem->Exec("mv track_rate_TOB.C Rate_Plots_try");
  gSystem->Exec("mv track_rate_TEC.C Rate_Plots_try");
  gSystem->Exec("mv track_rate_TEC_plus.C Rate_Plots_try");
  gSystem->Exec("mv track_rate_TEC_minus.C Rate_Plots_try");
  ...
  // xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx Plotting Track Rates Ended xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx//
