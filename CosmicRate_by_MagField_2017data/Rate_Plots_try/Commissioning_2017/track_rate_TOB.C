...
//=========  (Thu Jun 24 11:23:55 2021) by ROOT version6.10/04
   ...
   gStyle->SetOptStat(0);
   Canvas9->Range(289175.3,-1.026606,293420,6.906255);
   ...
   0.06030185,
   0.04039461};
   TGraphErrors *gre = new TGraphErrors(375,Graph_fx1019,Graph_fy1019,Graph_fex1019,Graph_fey1019);
   gre->SetName("Graph");
   gre->SetTitle("Graph");
   gre->SetFillColor(1);
   ...
   TH1F *Graph_Graph1019 = new TH1F("Graph_Graph1019","Graph",375,289825.9,293403.1);
   Graph_Graph1019->SetMinimum(0);
   Graph_Graph1019->SetMaximum(6.507267);
   ...
   0.1921938,
   0.1107074};
   gre = new TGraphErrors(62,Graph_fx1020,Graph_fy1020,Graph_fex1020,Graph_fey1020);
   gre->SetName("Graph");
   gre->SetTitle("Graph");
   gre->SetFillColor(1);
   ...
   TH1F *Graph_Graph1020 = new TH1F("Graph_Graph1020","Graph",100,293391,294591);
   Graph_Graph1020->SetMinimum(0.131901);
   Graph_Graph1020->SetMaximum(3.383836);
