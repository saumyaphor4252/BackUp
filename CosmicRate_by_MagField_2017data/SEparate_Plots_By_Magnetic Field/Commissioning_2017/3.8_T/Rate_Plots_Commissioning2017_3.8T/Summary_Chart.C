...
//=========  (Wed Jun 23 22:40:33 2021) by ROOT version6.10/04
   ...
   c->Range(-1,-0.5033654,9,4.530288);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   h1b__1->SetBinContent(1,3.835165);
   h1b__1->SetBinContent(2,2.74956);
   h1b__1->SetBinContent(3,0.04553823);
   h1b__1->SetBinContent(4,0.008104271);
   h1b__1->SetBinContent(5,1.100186);
   h1b__1->SetBinContent(6,0.5752909);
   h1b__1->SetBinContent(7,2.52402);
   h1b__1->SetBinContent(8,0.8270973);
