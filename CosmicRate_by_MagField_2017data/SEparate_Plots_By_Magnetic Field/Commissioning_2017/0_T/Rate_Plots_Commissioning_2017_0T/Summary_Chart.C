...
//=========  (Wed Jun 23 20:27:11 2021) by ROOT version6.10/04
   TCanvas *c = new TCanvas("c", "c",193,183,800,600);
   c->Range(-1,-0.4890071,9,4.401064);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   h1b__1->SetBinContent(1,3.725768);
   h1b__1->SetBinContent(2,2.261098);
   h1b__1->SetBinContent(3,0.009775908);
   h1b__1->SetBinContent(4,0.001448487);
   h1b__1->SetBinContent(5,1.075091);
   h1b__1->SetBinContent(6,0.3336278);
   h1b__1->SetBinContent(7,2.140974);
   h1b__1->SetBinContent(8,0.4556438);
