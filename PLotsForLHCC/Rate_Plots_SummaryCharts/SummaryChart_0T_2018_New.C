...
//=========  (Wed Aug 25 12:06:45 2021) by ROOT version6.10/04
   TCanvas *c = new TCanvas("c", "c",372,87,856,842);
   c->Range(-1.553285,-0.6814158,8.420438,4.783819);
   c->SetFillColor(0);
   c->SetBorderMode(0);
   c->SetBorderSize(2);
   c->SetGridx();
   ...
   h1b__1->SetBinContent(1,4.035519);
   h1b__1->SetBinContent(2,2.333595);
   h1b__1->SetBinContent(3,0.03464845);
   h1b__1->SetBinContent(4,0.09089546);
   h1b__1->SetBinContent(5,1.129583);
   h1b__1->SetBinContent(6,0.3442483);
   h1b__1->SetBinContent(7,2.221687);
   h1b__1->SetBinContent(8,0.4614066);
