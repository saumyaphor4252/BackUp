  ...
  for(int i=0;i<8;i++)
    {
      ...
      int ci;
      if(i==0) { ci=TColor::GetColor(kMagenta); }
      else if(i==1) { ci=TColor::GetColor(kGreen+1); }
      else if(i==2) { ci=TColor::GetColor(kRed); }
      else if(i==3) { ci=TColor::GetColor(kOrange+7); }
      else if(i==4) { ci=TColor::GetColor(kCyan); }
      else if(i==5) { ci=TColor::GetColor(kBlue); }
      else if(i==6) { ci=TColor::GetColor(kGreen+3); }
      else if(i==7) { ci=TColor::GetColor(kYellow-3); }
      else if(i==8) { ci=TColor::GetColor(kViolet-3); }
      ...
      for (Long64_t jentry = 0; jentry < n; jentry++)  // Loop over Runs
	{
      ...
      gr_event_rate->SetMarkerSize(1.5);
      ...
      gr_track_rate->SetMarkerSize(1.5);
      ...
      gr_track_rate_PIX->SetMarkerSize(1.5);
      ...
      gr_track_rate_FPIX->SetMarkerSize(1.5);
      ...
      gr_track_rate_BPIX->SetMarkerSize(1.5);
      ...
      gr_track_rate_TOB->SetMarkerSize(1.5);
      ...
      gr_track_rate_TIB->SetMarkerSize(1.5);
      ...
      gr_track_rate_TIDM->SetMarkerSize(1.5);
      ...
      gr_track_rate_TIDP->SetMarkerSize(1.5);
      ...
      gr_track_rate_TID->SetMarkerSize(1.5);
      ...
      gr_track_rate_TEC->SetMarkerSize(1.5);
      ...
      gr_track_rate_TECM->SetMarkerSize(1.5);
      ...
      gr_track_rate_TECP->SetMarkerSize(1.5);
